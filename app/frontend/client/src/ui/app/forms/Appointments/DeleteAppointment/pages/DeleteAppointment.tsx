        ...
        return (
            <>
                ...
                <Form onSubmitForm={handleDelete} />
                    <Footer />
                {renderModal(modal, setModal, handleCloseModal, errorMessage, handleConfirmDelete)}
            </>
        );
    };

    function renderModal(modal, setModal, handleCloseModal, errorMessage, handleConfirmDelete) {
        switch (modal.type) {
            case "success":
                return (
                    <Success
